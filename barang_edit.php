<?php
    ...
    if(isset($_POST['simpan'])){
        ...
        $stmt=$conn->prepare('UPDATE barang SET nama_barang=? WHERE id_barang=?');
        $stmt->bind_param("ss", $nama_barang, $id_barang);
        $stmt->execute();
    ...
    echo "<script>
            ...
            window.location='barang_data.php';
            </script>";
    }
                ...
                <div class="container-fluid">
                    ...
                    ?>
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-md-12">
                                <label for="validationCustom08" class="form-label">ID barang</label>
                                <input type="text" class="form-control" style="background-color: #dee2e6" id="validationCustom01" pattern="^[A-Za-z]+([\A-Za-z]+)*" name="id_barang" value="<?php echo $id_barang?>" readonly required>
                            </div>
                                <div class="col-md-12 form-group">
                                    <label for="validationCustom08" class="form-label">Nama barang</label>
                                    <input type="text" class="form-control" style="background-color: #dee2e6" id="validationCustom08" pattern="^[A-Za-z]+([\A-Za-z]+)*" name="nama_barang" placeholder="Nama Barang" value="<?php echo $nama_barang?>" required>
