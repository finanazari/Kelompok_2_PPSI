<?php
    ...
    if(!$hasil = $conn->query("SELECT * FROM transaksi join pelanggan on transaksi.id_pelanggan=pelanggan.id_pelanggan
                                        join user on transaksi.id_user=user.id_user where transaksi.id_status_laundry='SL002'")){
                ...
                <div class="container-fluid">
                    ...
                    ?>
                        ...
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">DATA TRANSAKSI SELESAI</h6>
                        </div>
                        <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <form method="POST" action="">  
                                                        <a role="button" href="transaksi_data_selesai_detail.php?id_transaksi=<?php echo $row['id_transaksi'];?>" class="btn btn-outline-info">
