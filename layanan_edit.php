<?php
    ...
    if(isset($_POST['simpan'])){
        ...
        $stmt=$conn->prepare('UPDATE layanan SET layanan=? WHERE id_layanan=?');
        $stmt->bind_param("ss", $layanan, $id_layanan);
        $stmt->execute();

        if($conn->affected_rows > 0){
            $pesan_sukses= "Data layanan berhasil disimpan!";
        }
        else{
            $pesan_gagal= "Data layanan gagal disimpan!";
        }
        $stmt->close();
    }
    ...
    echo "<script>
            ...
            window.location='layanan_data.php';
            </script>";
    }
                    ...
                    ?>
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-md-12 form-group">
                                <label for="validationCustom08" class="form-label">ID layanan</label>
                                <input type="text" class="form-control" style="background-color: #dee2e6" id="validationCustom01" pattern="^[A-Za-z]+([\A-Za-z]+)*" name="id_layanan" value="<?php echo $id_layanan?>" readonly required>
                            </div>
                                <div class="col-md-12 form-group">
                                    <label for="validationCustom08" class="form-label">Nama layanan</label>
                                    <input type="text" class="form-control" style="background-color: #dee2e6" id="validationCustom08" pattern="^[A-Za-z]+([\A-Za-z]+)*" name="layanan" placeholder="Nama Layanan" value="<?php echo $layanan?>" required>
                                    <div class="invalid-feedback">
                                        Masukkan Data Nama layanan Dengan Benar!
                                    </div>
                                </div>
                                <div class="col-md-12 form-group"><br>
                                    ...
                                    <a style="float:right" href="layanan_data.php" class="btn btn-outline-primary btn-mt" name="back">
