<?php
    ...
    if(isset($_POST['simpan'])){
        ...
        $stmt=$conn->prepare('INSERT INTO layanan VALUES (?,?)');
        $stmt->bind_param("ss", $id_layanan, $layanan);
        $stmt->execute();
...
<head>
    ...
    <title>Form Tambah Layanan</title>
                ...
                <div class="container-fluid">
                    ...
                    ?>
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-md-12">
                                <?php
                                    $data = $conn->query("SELECT MAX(RIGHT(id_layanan, 3)) as id_layanan FROM layanan");
                                    $no=0;
                                    ...
                                    $conn->close();
                                ?>
                                <input type="text" class="form-control" style="background-color: #dee2e6" id="validationCustom01" pattern="^[A-Za-z]+([\A-Za-z]+)*" name="id_layanan" value=<?php echo "LY$new_code"?> readonly required>
                            </div>
                                <div class="col-md-12 form-group">
                                    <label for="validationCustom08" class="form-label">Nama layanan</label>
                                    <input autofocus type="text" class="form-control" style="background-color: #dee2e6" id="validationCustom08" pattern="^[A-Za-z]+([\A-Za-z]+)*" name="layanan" placeholder="Nama Layanan" required>
